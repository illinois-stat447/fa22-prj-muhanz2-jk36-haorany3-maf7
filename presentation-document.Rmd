...
![](img/muhan/prosperity_score_distribution.png){width=50%}
...
![](img/muhan/pruning_accuracy.png){width=50%}
...
![Decision tree visualization](img/muhan/decision_tree.png){width=80%}
